...
# ACDS 18.1 625 win32 2019.01.16.15:47:03
...
# ----------------------------------------
# If fyp_clkctrl is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fyp_clkctrl_altclkctrl_0.v" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fyp_clkctrl.v"                                                                                   
fi
