...
module  fyp_clkctrl_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //fyp_clkctrl_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  fyp_clkctrl_altclkctrl_0  (
    inclk,
    outclk);
    ...
    fyp_clkctrl_altclkctrl_0_sub  fyp_clkctrl_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
