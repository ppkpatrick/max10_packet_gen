...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fyp_clkctrl"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fyp_clkctrl_altclkctrl_0.v" -work altclkctrl_0
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fyp_clkctrl.v"                                           
}
